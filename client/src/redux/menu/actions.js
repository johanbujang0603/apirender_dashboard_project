...
import {
  ...
  MENU_GET_LAETST_PROJECTS_ERROR,
  
} from '../actions';

export const setProjectMenuItems = (payload) => {
  return {
    type: MENU_GET_LATEST_PROJECTS,
    payload,
  }
}

export const setProjectMenuItemsSuccess = (payload) => {
  return {
    type: MENU_GET_LAETST_PROJECTS_SUCCESS,
    payload,
  }
}

export const setProjectMenuItemsError = (payload) => {
  return {
    type: MENU_GET_LAETST_PROJECTS_ERROR,
    payload,
  }
}
