...
const PDCRMDevelopment = ({ service, orders, downloads, brief, backupNotes, clientView }) => {
  const [activeTab, setActiveTab] = useState('details');
  return (
    <>
      <Row className="chat-row">
        <Colxx md="12" sm="12">
          <h5 className="mb-2">CRM Development</h5>
...
export default injectIntl(PDCRMDevelopment);
