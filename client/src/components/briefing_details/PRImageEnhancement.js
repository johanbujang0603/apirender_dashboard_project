...
const PRImageEnhancement = ({ service, orders, downloads, brief, backupNotes, clientView }) => {
  const [activeTab, setActiveTab] = useState('details');
  return (
    <>
      <Row className="chat-row">
        <Colxx md="12" sm="12">
          <h5 className="mb-2">360 Image Enhancement</h5>
                      ...
                      <Row>
                        <Colxx sm="12">
                        {
                          (orders.find(
                            (o) =>
                              o.value ===
                              "360_IMAGE_ENHANCEMENT_VIRTUAL_FURNITURE_COMMERCIAL"
                          ) != undefined ||
                            orders.find(
                              (o) =>
                                o.value ===
                                "360_IMAGE_ENHANCEMENT_VIRTUAL_FURNITURE_RESIDENTIAL"
                            ) != undefined) && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
                                    <IntlMessages id="briefing.360-virtual-furniture" />
                                  </span>
                                </p>
                                <p className="mb-3 pt-3 pb-2">{ brief.virtualFurniture }</p>
