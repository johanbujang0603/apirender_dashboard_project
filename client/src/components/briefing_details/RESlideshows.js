  ...
  return (
    <>
      <Row className="chat-row">
        <Colxx md="12" sm="12">
          <h5 className="mb-4">SlideShows</h5>
          <Card className="mb-4">
            <CardHeader>
                      ...
                      <Row>
                          ...
                          {brief.contactName && (
                            <>
                              <p className="m-0 pt-3 pb-2 d-flex align-items-center border-dotted-bottom">
                                <span className="text-theme-1 font-weight-bold">
                                  <IntlMessages id="briefing.contact-name" />
                                </span>
                        ...
                        <Colxx sm="12">
                          <p className="m-0 pb-5">
                            <span className="text-theme-1 font-weight-bold">
                              <IntlMessages id="briefing.company-logo" />
                            </span>
                          </p>
                          <Row>
                        ...
                        <Colxx sm="12">
                          {brief.contactNumber && (
                            <>
                              <p className="m-0 pt-3 pb-2 d-flex align-items-center border-dotted-bottom">
                                <span className="text-theme-1 font-weight-bold">
                                  <IntlMessages id="briefing.contact-number" />
                                </span>
                                <span className="ml-auto">
                                {brief.contactNumber}
                                </span>
                        ...
                        <Colxx sm="12">
                          {brief.contactEmail && (
                            <>
                              <p className="m-0 pt-3 pb-2 d-flex align-items-center border-dotted-bottom">
                                <span className="text-theme-1 font-weight-bold">
                                  <IntlMessages id="briefing.contact-email" />
                                </span>
                                <span className="ml-auto">
                                {brief.contactEmail}
                                </span>
