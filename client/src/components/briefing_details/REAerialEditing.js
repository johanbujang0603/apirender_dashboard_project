...
const REAerialEditing = ({ service, orders, downloads, brief, backupNotes }) => {
  const [activeTab, setActiveTab] = useState('details');
  return (
    <>
      <Row className="chat-row">
        <Colxx md="12" sm="12">
          <h5 className="mb-4">Aerial Editing</h5>
          <Card className="mb-4">
            <CardHeader>
                  ...
                  <Colxx sm="12">
                    <CardBody>
                      <Row>
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "RE_AERIAL_EDITING_COLOUR_FADE") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "RE_AERIAL_EDITING_LOCATION_PIN_DROP") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "RE_AERIAL_EDITING_SINGLE_LOT_HIGHLIGHT") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "RE_AERIAL_EDITING_MULTIPLE_LOT_HIGHLIGHT") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
