...
const PRVirtualFurniture = ({ service, orders, downloads, brief, backupNotes, clientView }) => {
  const [activeTab, setActiveTab] = useState('details');
  return (
    <>
      <Row className="chat-row">
        <Colxx md="12" sm="12">
          <h5 className="mb-2">Virtual Furniture</h5>
                      ...
                      <Row>
                        ...
                        <Colxx sm="12">
                        {
                          (orders.find(
                            (o) =>
                              o.value ===
                              "VIRTUAL_FURNITURE_REMOVAL_LARGE_ITEMS"
                          ) != undefined ||
                            orders.find(
                              (o) =>
                                o.value ===
                                "VIRTUAL_FURNITURE_REMOVAL_SMALL_ITEMS"
                            ) != undefined) && (
                              <>
