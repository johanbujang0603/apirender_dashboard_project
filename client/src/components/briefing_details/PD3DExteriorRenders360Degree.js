...
const PD3DExteriorRenders360Degree = ({
  service,
  orders,
  downloads,
  brief,
  ...
  return (
    <>
      <Row className="chat-row">
        <Colxx md="12" sm="12">
          <h5 className="mb-2">3D Exterior Renders (360 Degree)</h5>
                          ...
                          <Row>
                            {downloads.map((download, index) => {
                              if (
                                ...
                                "PD_3D_EXTERIOR_RENDERS_360_DEGREE_PHOTO_MONTAGE"
                              ) {
                                return (
                        ...
                        <Colxx sm="12">
                          ...
                          <Row>
                            {downloads.map((download, index) => {
                              if (
                                download.service_option ==
                                "PD_3D_EXTERIOR_RENDERS_360_DEGREE_INCORPORATE_ENVIRONMENT"
                              ) {
                                return (
                                  <Colxx sm="3" md="2" key={index}>
                                    <p
                          ...
                          {brief.height && (
                            <>
                              <p className="m-0 pt-3 pb-2 d-flex align-items-center border-dotted-bottom">
                                ...
                                <span className="ml-auto">{brief.height}</span>
                              </p>
                            </>
                          )}
                        </Colxx>
                          ...
                          {brief.fencing && (
                            <>
                              <p className="m-0 pt-3 pb-2 d-flex align-items-center border-dotted-bottom">
                                ...
                                <span className="ml-auto">{brief.fencing}</span>
                              </p>
                            </>
                          )}
                        </Colxx>
                          ...
                          {brief.mailbox && (
                            <>
                              <p className="m-0 pt-3 pb-2 d-flex align-items-center border-dotted-bottom">
                                ...
                                <span className="ml-auto">{brief.mailbox}</span>
                              </p>
                            </>
                          )}
                        </Colxx>
