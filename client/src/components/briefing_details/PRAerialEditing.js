...
const PRAerialEditing = ({ service, orders, downloads, brief, backupNotes }) => {
                  ...
                  <Colxx sm="12">
                    <CardBody>
                      <Row>
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "PR_AERIAL_EDITING_COLOUR_FADE") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "PR_AERIAL_EDITING_LOCATION_PIN_DROP") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "PR_AERIAL_EDITING_SINGLE_LOT_HIGHLIGHT") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
                        ...
                        <Colxx sm="12">
                        {
                          orders.find((o) => o.value === "PR_AERIAL_EDITING_MULTIPLE_LOT_HIGHLIGHT") != undefined && (
                              <>
                                <p className="m-0 pt-3 pb-2">
                                  <span className="text-theme-1 font-weight-bold">
