    ...
    <>
      <Row>
        <Colxx md="12">
          <Card className="mb-4">
            <CardBody>
              <h5 className="text-primary mb-5">Site Plan</h5>
                ...
                <FormGroup row>
                  <Colxx sm={12}>
                    ...
                    <p className="text-muted text-small">
                      ...
                      If you have a company or project style/branding guide, please also upload this document so that we can create a site plan template consistent with your branding.
                    </p>
                  </Colxx>
                  <Colxx sm={6}>
...
export default injectIntl(PMSitePlan);
