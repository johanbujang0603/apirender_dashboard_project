...
import { grassEnhancementExamples } from "../../constants/aerialEditingValues";
...
const REAerialEditing = ({ service, orders, history }) => {
          ...
          <Card className="mb-4">
            <CardBody>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                {(orders.find(
                  (o) => o.value === "RE_AERIAL_EDITING_LARGE_ITEMS"
                ) !== undefined ||
                  orders.find(
                    (o) => o.value === "RE_AERIAL_EDITING_SMALL_ITEMS"
                  ) !== undefined) && (
                  <FormGroup>
                    <Label className="font-weight-bold">
                ...
                {orders.find(
                  (o) => o.value === "RE_AERIAL_EDITING_COLOUR_FADE"
                ) !== undefined && (
                  <FormGroup>
                    <Label className="font-weight-bold">
                ...
                {orders.find(
                  (o) => o.value === "RE_AERIAL_EDITING_LOCATION_PIN_DROP"
                ) !== undefined && (
                  <FormGroup>
                    <Label className="font-weight-bold">
                ...
                {orders.find(
                  (o) => o.value === "RE_AERIAL_EDITING_SINGLE_LOT_HIGHLIGHT"
                ) !== undefined && (
                  <FormGroup>
                    <Label className="font-weight-bold">
                ...
                {orders.find(
                  (o) => o.value === "RE_AERIAL_EDITING_MULTIPLE_LOT_HIGHLIGHT"
                ) !== undefined && (
                  <FormGroup>
                    <Label className="font-weight-bold">
...
export default injectIntl(REAerialEditing);
