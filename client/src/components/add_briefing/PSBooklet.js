...
const PSBooklet = ({ service, orders, history, project }) => {
    ...
    <>
      <Row>
        <Colxx md="12">
          <Card className="mb-4">
            <CardBody>
              <h5 className="text-primary mb-5">Booklet Printing (US Only) - Min. 10 Qty.</h5>
              <Form onSubmit={handleSubmit}>
                <FormGroup>
                  <a href="/assets/pdf/INFO_BOOKLET.pdf" download >Download File Preparation Guide.</a>
                </FormGroup>
                <FormGroup>
...
export default injectIntl(PSBooklet);
