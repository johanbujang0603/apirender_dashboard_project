...
const PD3DExteriorRenders360Degree = ({ service, orders, history }) => {
  const dropzone = useRef();
  const photoMontageDropzone = useRef();
  const incorporateEnvironmentDropzone = useRef();
  ...
  const handleSubmit = (event) => {
    ...
    files = photoMontageDropzone.current.myDropzone.files;
    files.forEach((file) => { postFormData.append("PD_3D_EXTERIOR_RENDERS_360_DEGREE_PHOTO_MONTAGE", file)});

    files = incorporateEnvironmentDropzone.current.myDropzone.files;
    files.forEach((file) => { postFormData.append("PD_3D_EXTERIOR_RENDERS_360_DEGREE_INCORPORATE_ENVIRONMENT", file)});
    ...
    axios.post(`/api/briefing/save`, postFormData, config)
    .then((res) => {
      setLoading(false);
    ...
    <>
      <Row>
        <Colxx md="12">
          <Card className="mb-4">
            <CardBody>
              <h5 className="text-primary mb-5">3D Exterior Renders (360 Degree)</h5>
              <Form onSubmit={handleSubmit}>
                ...
                <FormGroup>
                  <Label className="font-weight-bold">
                    <IntlMessages id="briefing.photo-montage" />
                  </Label>
                  <p className="text-small text-muted">
                    <IntlMessages id="briefing.photo-montage-description" />
                  </p>
                  <FileDropzone ref={photoMontageDropzone} />
                </FormGroup>
                <FormGroup>
                  <Label className="font-weight-bold">
                  ...
                  <p className="text-small text-muted">
                    ...
                    <Row>
                      ...
                      <Colxx>
                        <FileDropzone ref={incorporateEnvironmentDropzone} />
                      </Colxx>
                    </Row>
                </FormGroup>
                <FormGroup row>
                ...
                <FormGroup row>
                  <Colxx sm="4">
                    ...
                    >
                      <option value="" disabled></option>
                      <option value="Timber (Light-Colored)">Timber (Light-Colored)</option>
                      <option value="Timber (Dark-Colored)">Timber (Dark-Colored)</option>
                  ...
                  <Colxx sm="4">
                    ...
                    >
                      ...
                      <option value="Rendered/Concrete">Rendered/Concrete</option>
...
export default injectIntl(PD3DExteriorRenders360Degree);
