...
const PSPullupBanners = ({ service, orders, history, project }) => {
    ...
    <>
      <Row>
        <Colxx md="12">
          <Card className="mb-4">
            <CardBody>
              <h5 className="text-primary mb-2">Pull-up Banners</h5>
              <p className="text-danger mb-3 text-small">{orders.map((order) => order.name).join(', ')}</p>
              <Form onSubmit={handleSubmit}>
                <FormGroup>
                  <a href="/assets/pdf/PULL_UP_BANNER.pdf" download >Download File Preparation Guide.</a>
                </FormGroup>
                <FormGroup>
                  ...
                  Upload your print-ready file here. Refer to the Preparation Guide for instructions on creating your file. &nbsp;
...
export default injectIntl(PSPullupBanners);
