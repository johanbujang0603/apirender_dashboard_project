    ...
    <>
      <Row>
        <Colxx md="12">
          <Card className="mb-4">
            <CardBody>
              <h5 className="text-primary mb-5">Virtual Pool Construction</h5>
              <Form onSubmit={handleSubmit}>
                ...
                <FormGroup>
                  <Label className="font-weight-bold">
                    Please provide further instructions and notes here.
                  </Label>
                  <Row>
                    <Colxx>
                      <Input
...
export default injectIntl(VRPoolConstruction);
